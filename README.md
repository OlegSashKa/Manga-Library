...
- ✅ Скачивание книг/манги с сторонних ресурсов через api
- ✅ Читалка с прогрессом чтения

- ### Интеграции с API
- ✅ [WorldTimeAPI](https://api-ninjas.com/api/worldtime) - текущее время в Токио(возвожна замена или полное удаление)
- ✅ 
